...
# on heap memory size
# PIPE-014: explicit sizing - the auto-calculation grabbed ~40% of the Docker VM
# and the query/schema pools still starved under load (memory-exhaustion incident
# 2026-08-13). Fixed values keep IoTDB predictable beside ~35 other containers.
ON_HEAP_MEMORY="3G"
