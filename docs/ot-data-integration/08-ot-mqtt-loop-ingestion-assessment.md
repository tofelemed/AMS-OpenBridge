...
6. **Quality:** tuple quality = worst-of members; a required member stale beyond `stale_after_seconds` ⇒ emit the tick with `quality: "BAD"` (bad ticks feed exclusion gates; skipped ticks vanish). Never emit before pv+sp+op have each been seen once.
