...
#
# Read changes_tracker.md "Deployment checklist" first. Step 0 below needs no deploy
# at all and is the one that unblocks the fleet - do it, confirm it, and only then
# decide whether the binaries are urgent.
...
#    traverse-ingestion-service  GET /api/ingestion/stats -> paramRoles.VP == "vp"
...
#    flink                       4 x RUNNING and every start time moved (step 5)
#    ams-frontend                200 on /, users Ctrl+F5
#    fleet                       ops/diagnose-gate-failures.sql queries 2-3: G1 no longer
#                                the universal failure, avg_auto_pct off zero
"""
