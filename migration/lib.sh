...
load_env() {
  ...
  KAFKA_BOOTSTRAP_INTERNAL="${KAFKA_BOOTSTRAP_INTERNAL:-kafka-1:9092,kafka-2:9092,kafka-3:9092}"
  KAFKA_TOPIC_RF="${KAFKA_TOPIC_RF:-3}"
  KAFKA_TOPIC_MIN_ISR="${KAFKA_TOPIC_MIN_ISR:-2}"
