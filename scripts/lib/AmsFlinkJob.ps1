...
# RETIRED (audit-jobs.md Phase G, 2026-09-01): Loop KPI Engine helpers removed —
# the job consumed a topic with no producer and is deleted from src/flink.
...
# RETIRED (audit-jobs.md Phase G, 2026-09-01): State Drift Detection helpers removed —
# the job consumed a topic with no producer and is deleted from src/flink.
